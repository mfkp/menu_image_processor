    ...
    rb_define_mysql_const(ER_CONST_EXPR_IN_PARTITION_FUNC_ERROR);
    ...
    rb_define_mysql_const(ER_WARN_AUTO_CONVERT_LOCK);
    rb_define_mysql_const(ER_NO_AUTO_CONVERT_LOCK_STRICT);
    rb_define_mysql_const(ER_NO_AUTO_CONVERT_LOCK_TRANSACTION);
    rb_define_mysql_const(ER_NO_STORAGE_ENGINE);
    rb_define_mysql_const(ER_BACKUP_BACKUP_START);
    rb_define_mysql_const(ER_BACKUP_BACKUP_DONE);
    rb_define_mysql_const(ER_BACKUP_RESTORE_START);
    rb_define_mysql_const(ER_BACKUP_RESTORE_DONE);
    rb_define_mysql_const(ER_BACKUP_NOTHING_TO_BACKUP);
    rb_define_mysql_const(ER_BACKUP_CANNOT_INCLUDE_DB);
    rb_define_mysql_const(ER_BACKUP_BACKUP);
    rb_define_mysql_const(ER_BACKUP_RESTORE);
    rb_define_mysql_const(ER_BACKUP_RUNNING);
    rb_define_mysql_const(ER_BACKUP_BACKUP_PREPARE);
    rb_define_mysql_const(ER_BACKUP_RESTORE_PREPARE);
    rb_define_mysql_const(ER_BACKUP_INVALID_LOC);
    rb_define_mysql_const(ER_BACKUP_READ_LOC);
    rb_define_mysql_const(ER_BACKUP_WRITE_LOC);
    rb_define_mysql_const(ER_BACKUP_LIST_DBS);
    rb_define_mysql_const(ER_BACKUP_LIST_TABLES);
    rb_define_mysql_const(ER_BACKUP_LIST_DB_TABLES);
    rb_define_mysql_const(ER_BACKUP_SKIP_VIEW);
    rb_define_mysql_const(ER_BACKUP_NO_ENGINE);
    rb_define_mysql_const(ER_BACKUP_TABLE_OPEN);
    rb_define_mysql_const(ER_BACKUP_READ_HEADER);
    rb_define_mysql_const(ER_BACKUP_WRITE_HEADER);
    rb_define_mysql_const(ER_BACKUP_NO_BACKUP_DRIVER);
    rb_define_mysql_const(ER_BACKUP_NOT_ACCEPTED);
    rb_define_mysql_const(ER_BACKUP_CREATE_BACKUP_DRIVER);
    rb_define_mysql_const(ER_BACKUP_CREATE_RESTORE_DRIVER);
    rb_define_mysql_const(ER_BACKUP_TOO_MANY_IMAGES);
    rb_define_mysql_const(ER_BACKUP_WRITE_META);
    rb_define_mysql_const(ER_BACKUP_READ_META);
    rb_define_mysql_const(ER_BACKUP_CREATE_META);
    rb_define_mysql_const(ER_BACKUP_GET_BUF);
    rb_define_mysql_const(ER_BACKUP_WRITE_DATA);
    rb_define_mysql_const(ER_BACKUP_READ_DATA);
    rb_define_mysql_const(ER_BACKUP_NEXT_CHUNK);
    rb_define_mysql_const(ER_BACKUP_INIT_BACKUP_DRIVER);
    rb_define_mysql_const(ER_BACKUP_INIT_RESTORE_DRIVER);
    rb_define_mysql_const(ER_BACKUP_STOP_BACKUP_DRIVER);
    rb_define_mysql_const(ER_BACKUP_STOP_RESTORE_DRIVERS);
    rb_define_mysql_const(ER_BACKUP_PREPARE_DRIVER);
    rb_define_mysql_const(ER_BACKUP_CREATE_VP);
    rb_define_mysql_const(ER_BACKUP_UNLOCK_DRIVER);
    rb_define_mysql_const(ER_BACKUP_CANCEL_BACKUP);
    rb_define_mysql_const(ER_BACKUP_CANCEL_RESTORE);
    rb_define_mysql_const(ER_BACKUP_GET_DATA);
    rb_define_mysql_const(ER_BACKUP_SEND_DATA);
    rb_define_mysql_const(ER_BACKUP_SEND_DATA_RETRY);
    rb_define_mysql_const(ER_BACKUP_OPEN_TABLES);
    rb_define_mysql_const(ER_BACKUP_THREAD_INIT);
    rb_define_mysql_const(ER_BACKUP_PROGRESS_TABLES);
    rb_define_mysql_const(ER_TABLESPACE_EXIST);
    rb_define_mysql_const(ER_NO_SUCH_TABLESPACE);
    rb_define_mysql_const(ER_SLAVE_HEARTBEAT_FAILURE);
    rb_define_mysql_const(ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE);
    rb_define_mysql_const(ER_BACKUP_CANT_FIND_SE);
    rb_define_mysql_const(ER_BACKUP_NO_NATIVE_BE);
    rb_define_mysql_const(ER_BACKUP_UNKNOWN_BE);
    rb_define_mysql_const(ER_BACKUP_WRONG_TABLE_BE);
    rb_define_mysql_const(ER_BACKUP_CANT_RESTORE_DB);
    rb_define_mysql_const(ER_BACKUP_CANT_RESTORE_TABLE);
    rb_define_mysql_const(ER_BACKUP_CANT_RESTORE_VIEW);
    rb_define_mysql_const(ER_BACKUP_CANT_RESTORE_SROUT);
    rb_define_mysql_const(ER_BACKUP_CANT_RESTORE_EVENT);
    rb_define_mysql_const(ER_BACKUP_CANT_RESTORE_TRIGGER);
    rb_define_mysql_const(ER_BACKUP_CATALOG_ADD_DB);
    rb_define_mysql_const(ER_BACKUP_CATALOG_ADD_TABLE);
    rb_define_mysql_const(ER_BACKUP_CATALOG_ADD_VIEW);
    rb_define_mysql_const(ER_BACKUP_CATALOG_ADD_SROUT);
    rb_define_mysql_const(ER_BACKUP_CATALOG_ADD_EVENT);
    rb_define_mysql_const(ER_BACKUP_CATALOG_ADD_TRIGGER);
    rb_define_mysql_const(ER_BACKUP_UNKNOWN_OBJECT);
    rb_define_mysql_const(ER_BACKUP_UNKNOWN_OBJECT_TYPE);
    rb_define_mysql_const(ER_BACKUP_OPEN_WR);
    rb_define_mysql_const(ER_BACKUP_OPEN_RD);
    rb_define_mysql_const(ER_BACKUP_BAD_MAGIC);
    rb_define_mysql_const(ER_BACKUP_CONTEXT_CREATE);
    rb_define_mysql_const(ER_BACKUP_CONTEXT_REMOVE);
    rb_define_mysql_const(ER_BAD_PATH);
    rb_define_mysql_const(ER_DDL_BLOCK);
    rb_define_mysql_const(ER_BACKUP_LOGGER_INIT);
    rb_define_mysql_const(ER_BACKUP_WRITE_SUMMARY);
    rb_define_mysql_const(ER_BACKUP_READ_SUMMARY);
    rb_define_mysql_const(ER_BACKUP_GET_META_DB);
    rb_define_mysql_const(ER_BACKUP_GET_META_TABLE);
    rb_define_mysql_const(ER_BACKUP_GET_META_VIEW);
    rb_define_mysql_const(ER_BACKUP_GET_META_SROUT);
    rb_define_mysql_const(ER_BACKUP_GET_META_EVENT);
    rb_define_mysql_const(ER_BACKUP_GET_META_TRIGGER);
    rb_define_mysql_const(ER_BACKUP_CREATE_BE);
    rb_define_mysql_const(ER_BACKUP_LIST_PERDB);
    rb_define_mysql_const(ER_BACKUP_LIST_DB_VIEWS);
    rb_define_mysql_const(ER_BACKUP_LIST_DB_SROUT);
    rb_define_mysql_const(ER_BACKUP_LIST_DB_EVENTS);
    rb_define_mysql_const(ER_BACKUP_LIST_DB_TRIGGERS);
    rb_define_mysql_const(ER_BACKUP_LOG_WRITE_ERROR);
    rb_define_mysql_const(ER_TABLESPACE_NOT_EMPTY);
    rb_define_mysql_const(ER_BACKUP_CAT_ENUM);
    rb_define_mysql_const(ER_BACKUP_CANT_RESTORE_TS);
    rb_define_mysql_const(ER_BACKUP_TS_CHANGE);
    rb_define_mysql_const(ER_BACKUP_GET_META_TS);
    rb_define_mysql_const(ER_TABLESPACE_DATAFILE_EXIST);
    rb_define_mysql_const(ER_BACKUP_CATALOG_ADD_TS);
    rb_define_mysql_const(ER_DEBUG_SYNC_TIMEOUT);
    rb_define_mysql_const(ER_DEBUG_SYNC_HIT_LIMIT);
    rb_define_mysql_const(ER_BACKUP_FAILED_TO_INIT_COMPRESSION);
    rb_define_mysql_const(ER_BACKUP_OBTAIN_NAME_LOCK_FAILED);
    rb_define_mysql_const(ER_BACKUP_RELEASE_NAME_LOCK_FAILED);
    rb_define_mysql_const(ER_BACKUP_BACKUPDIR);
